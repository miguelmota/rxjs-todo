...
describe('Todo tests', function () {
  it('clicks add button', function (done) {
    var $ = window.jQuery;
    ...
    $addTodoButton.click();
    //document.elementFromPoint(button.offsetLeft, button.offsetTop).click();
    done();
  });

  it('has new todo item', function (done) {
    var $input = $('header form input', document);
    assert.equal($input.val(), '');
    var $items = $('.segments .segment', document);
    assert.equal($items.length, 1);
    var $item = $items.find('input').eq(0);
    assert.equal($item.val(), 'Foobar');
    done();
  });
});
...
},{"./flag":15,"assertion-error":2,"type-detect":36}],15:[function(require,module,exports){
/*!
 * Chai - flag utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
...
},{"type-detect":36}],24:[function(require,module,exports){
/*!
 * chai
...
},{"./addChainableMethod":11,"./addMethod":12,"./addProperty":13,"./expectTypes":14,"./flag":15,"./getActual":16,"./getMessage":18,"./getName":19,"./getPathInfo":20,"./getPathValue":21,"./hasProperty":23,"./inspect":25,"./objDisplay":26,"./overwriteChainableMethod":27,"./overwriteMethod":28,"./overwriteProperty":29,"./test":30,"./transferFlags":31,"deep-eql":32,"type-detect":36}],25:[function(require,module,exports){
...
},{"base64-js":38,"ieee754":41,"isarray":40}],40:[function(require,module,exports){
